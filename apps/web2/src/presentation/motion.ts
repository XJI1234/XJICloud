...
export function materializeIn(el: Element, options: CloudSpringOptions = CLOUD_SPRING_DEFAULT) {
  if (prefersReducedMotion()) {
...
export function materializeOut(el: Element, options: CloudSpringOptions = CLOUD_SPRING_DEFAULT) {
  if (prefersReducedMotion()) {
