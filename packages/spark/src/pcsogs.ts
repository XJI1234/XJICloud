...
async function decodeImage(fileBytes: ArrayBuffer | Uint8Array) {
  ...
  const imageBlob = new Blob([normalizedFileBytes]);
...
async function decodeImageRgba(fileBytes: ArrayBuffer | Uint8Array) {
